...
export default function QuestionsAnswers({ productId }) {
  ...
  return (
    ...
    <MainContainer>
      ...
      <h2 data-testid={'test'}>Questions & Answers</h2>
      <br />
      <Wrapper>
        {' '}
        <SearchBar data-testid={'searchbar'} placeholder="Have A Question? Search For Answers..." onChange={(e) => setSearch(e.target.value)} />
