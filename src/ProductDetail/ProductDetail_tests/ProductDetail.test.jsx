...
test('should render ProductDetail component', () => {
  render(<ProductDetail
    ...
    styles={[{
      ...
      skus: {
        1281032: { quantity: 8, size: 'XS' }, 1281033: { quantity: 16, size: 'S' }, 1281034: { quantity: 17, size: 'M' }, 1281035: { quantity: 10, size: 'L' }, 1281036: { quantity: 15, size: 'XL' }, 1281037: { quantity: 4, size: 'XL' },
      },
    }, {
      style_id: 220999,
      ...
      skus: {
        1281038: { quantity: 8, size: 'XS' }, 1281039: { quantity: 16, size: 'S' }, 1281040: { quantity: 17, size: 'M' }, 1281041: { quantity: 10, size: 'L' }, 1281042: { quantity: 15, size: 'XL' }, 1281043: { quantity: 6, size: 'XXL' },
      },
    }]}
